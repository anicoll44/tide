...
def check_password():
    ...
    if "password_correct" not in st.session_state:
        ...
        st.text("TIDE helps teams analyze Google Trends data at scale. It returns data for requested keywords, suggests new keywords, and plots their relative interest over time to help with keyword research, headline optimization, trend shifts, and more.")
